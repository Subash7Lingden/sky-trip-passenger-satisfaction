...
def predict_datapoint():
    if request.method == "GET":
        ...
        if result ==0:
            ...
            return render_template("form.html", final_result = "Passenger Satisfied int this flight:{}" .forma(result))
